...
echo "Running QEMU..."
qemu-system-arm -M realview-pb-a8 -m 512M -kernel bin/program.bin -nographic -audio none
##qemu-system-arm -M versatilepb -kernel bin/program.bin -nographic -audio none
##beagle