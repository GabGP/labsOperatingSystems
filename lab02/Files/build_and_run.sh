...
rm -f root.o os.o stdio.o string.o main.o calculadora.elf calculadora.bin
...
arm-none-eabi-gcc -nostdlib -T linker.ld -o calculadora.elf root.o os.o stdio.o string.o main.o -lgcc
